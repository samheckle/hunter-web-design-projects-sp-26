...
| Important Links | |
|---|---|
| Office Hours | Friday 1:30pm - 3:30pm, book [here](https://calendly.com/samanthaheckle/30min) | 
| [Brightspace](https://brightspace.cuny.edu/d2l/le/content/1128616/Home) | For assignment due dates and submissions |
...
This project-based class is designed to give students the experience of solving practical problems in web production and to add to the advanced student's web design portfolio with a comprehensive project. Students will work independently and in teams on a large-scale collaborative project. Students will learn the entire process of web interface design from project idea to completion. They will learn to collaborate in design teams, present work-in-progress, perform user testing, and meet deadlines. Projects are designed for non-commercial, in-house (CUNY) or other non-for-profit organizations. Using the cycle of design, implementation, and user testing and revision, students will learn how to design a successful website.
...
1. A text editor
   - I use [VSCodium](https://vscodium.com/), which is an open source lightweight fork of [VSCode](https://code.visualstudio.com/), but you are welcome to use whatever is most comfortable.
   ...
   - Suggested extensions: [Prettier](https://prettier.io/), HTML CSS Intellisense, EJS Language Support
2. Sign up for a [Github account](https://github.com/)
   - Suggested sign up for [Github Student Developer Pack](https://education.github.com/pack)
3. Sign up for a DigitalOcean account
   - You can receive $200 free credits from the Github Student Developer Pack
   - If that doesn't work, or you already used it, you can use my [referral link](https://m.do.co/c/c57ec6b3cb5f).
   - If you do not use either, you should expect $4 / month of this class (~$24 total). This does not include any optional domain purchasing. If this is not feasible, please let me know.
4. Install an FTP service.
   - I use [Cyberduck](https://cyberduck.io/), but Filezilla is fine.
5. Command Line Tools
   - Windows: Install [GitBash](https://git-scm.com/downloads)
   - Mac: Terminal is pre-installed, but you need to enable [Xcode Command Line Tools](https://developer.apple.com/xcode/resources/) by opening Terminal and running `xcode-select --install`
...
| Schedule |                                                                    |
| -------- | ------------------------------------------------------------------ |
| 1/28     | Introduction, Git and GitHub                                       |
| 2/4      | Infrastructure: Computation and How 2 Research                     |
| 2/11     | Infrastructure: Project #1                                         |
| 2/18     | Infrastructure: Reading #1 Discussion                              |
| 2/25     | Surveillance: Project #2 Concept Crit, Cookies                     |
| 3/4      | Surveillance: Reading #2 Discussion                                |
| 3/11     | Compression & Friction: Storage                                    |
| 3/18     | Compression & Friction: Reading #3 Discussion                      |
| 3/25     | Compression & Friction: Project #2 (Midterm)                       |
| 4/1      | **_No class, spring break_**                                       |
| 4/8      | **_No class, spring break_**                                       |
| 4/15     | Community & Moderation: Reading #4 Discussion                      |
| 4/22     | Community & Moderation: Project #3 Design Crit                     |
| 4/29     | Death and What Comes Next: Reading #5 Discussion                   |
| 5/6      | Death and What Comes Next: Project #3 Prototype Crit               |
| 5/13     | Final 1:1s                                                         |
| 5/20     | Project #3 (Final) **last day for resubmissions and extra credit** |

### Projects

#### Project 1

Set up a blog on your cloud server. This will be where you post all writing for this class.

Deliverables:

- 2/11: Live blog link on your cloud server.

#### Project 2

Deliverables:

- 2/25: With your group, write out your concept on your blog. Each person should have the same concept pitch, but have specific ideas of how to implement their portion of the project.
- 3/25: Live website on your cloud server.

#### Project 3

Deliverables:

- 4/22: With your group, write out your concept on your blog and make wireframes and sitemaps.
- 5/6: Make a working prototype of your project to get feedback on.
- 5/20: Live website on your cloud server.

### Readings

#### Reading #1: Infrastructure

- [The Undersea Network](https://web.archive.org/web/20240211123315/https://blogs.commons.georgetown.edu/engl-711-fall2017/files/2017/08/The-Undersea-Network_Starosielski.pdf) - Nicole Starosielski, 2015
- [How to See Invisible Infrastructure](https://www.theatlantic.com/technology/archive/2015/08/how-to-see-invisible-infrastructure/401204/) - Ingrid Burrington, 2015
- Optional:
  - Scroll through [Networks of New York](https://c-i-r-c-u-l-a-t-i-o-n.org/media/pdf/Networks-of-New-York.pdf), created by Burrington documenting unseen networks in NYC

#### Reading #2: Surveillance

- [Age of Surveillance Capitalism, Ch 1](https://arena-attachments.s3.amazonaws.com/16000558/ca7ec9746b00ffe28db50d0278a6a72c.pdf?1649627612) - Shosana Zuboff, 2019
- [Facebook Got Rid of Racial Ad Categories. Or Did It?](https://themarkup.org/citizen-browser/2021/07/09/facebook-got-rid-of-racial-ad-categories-or-did-it) - Jon Keegan, 2021

#### Reading #3: Compression and Friction

- [The Web's Grain](https://frankchimero.com/blog/2015/the-webs-grain/) - Frank Chimero, 2015
- [ChatGPT is a Blurry JPEG of the Web](https://www.newyorker.com/tech/annals-of-technology/chatgpt-is-a-blurry-jpeg-of-the-web) - Ted Chiang, 2023
- [Heavy Lies the Digital Cloud](https://www.bylinebyline.com/articles/digital-cloud-memory-technology) - Emily Manges, 2025

#### Reading #4: Community and Moderation

- [Another Network is Possible](https://logicmag.io/bodies/another-network-is-possible/), April Glaser, 2015
- [Architecting Emergence](https://rhizome.org/editorial/2021/feb/17/architecting-emergence/), Zhenzhen Qi & Yang Wang, 2021
- [The woman who taught internet strangers to actually care for one another](https://qz.com/1309564/the-woman-who-taught-internet-strangers-to-actually-care-for-one-another) - Claire L. Evans, 2022

#### Reading #5: Death and What Comes Next
